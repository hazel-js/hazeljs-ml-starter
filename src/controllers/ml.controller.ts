...
const MODEL_CONFIG: Record<string, { pipeline: string; validLabels: string[]; customLabels?: boolean }> = {
  'sentiment-classifier': { pipeline: 'sentiment-preprocessing', validLabels: ['positive', 'negative', 'neutral'] },
  'embedding-sentiment-classifier': { pipeline: 'sentiment-preprocessing', validLabels: ['positive', 'negative', 'neutral'] },
  'spam-classifier': { pipeline: 'spam-preprocessing', validLabels: ['spam', 'ham'] },
  'intent-classifier': {
    ...
    customLabels: true, // allow any alphanumeric + underscore for custom intents
  },
};
